...
.avatar-bot { background: linear-gradient(135deg, #8b5cf6, #7c3aed); }
...
.bubble-bot { background: var(--bg-card); color: var(--text-primary); border: 1px solid var(--border-primary); border-top-left-radius: 4px; }
