...
<template>
  <div class="agent-view">
    <transition name="slide">
      <div v-if="showSidebar" class="agent-sidebar">
...
.conv-delete {
  ...
  background: transparent; color: inherit; opacity: 0;
  cursor: pointer; transition: all 0.2s;
}
...
.sidebar-empty .sub { font-size: 12px; opacity: 0.7; }
...
.sidebar-toggle:hover { color: var(--text-primary); background: var(--bg-secondary); }
